...
const skills = [
  ...
  },
  {
    ...
    description: (
      <p>
        I have hands-on experience working with <strong>Bootstrap</strong>, a widely used front-end framework,
        to create responsive, mobile-first, and visually appealing websites. I leverage its
        <strong> grid system</strong>, <strong> utility classes</strong>, and <strong> pre-styled components</strong>
        such as <strong> Navbars</strong>, <strong> Modals</strong>, <strong> Forms</strong>, and <strong> Buttons</strong>
        to accelerate development and ensure design consistency across devices.
      </p>
    )
  },
  {
